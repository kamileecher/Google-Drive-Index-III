...
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/Google-Drive-Index-III@1.0.0/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/Google-Drive-Index-III@1.0.0/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/Google-Drive-Index-III@1.0.0/js/markdown-it.min.js"></script>'
);
document.write(
...
if (UI.dark_mode) {
  document.write(
    `<style>* {box-sizing: border-box}body{color:rgba(255,255,255,.87);background-color:#1E252F}.mdui-theme-primary-${UI.main_color} .mdui-color-theme{background-color:#1E252F!important} .nexmoe-item{background-color: #273139!important;box-shadow:0 0.2em 1em rgb(0 0 0 / 30%)!important}</style>`
  );
}
function init() {
...
<script src="//cdn.jsdelivr.net/gh/cheems/Google-Drive-Index-III/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/cheems/Google-Drive-Index-III/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
